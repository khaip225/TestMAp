...
public class MainActivity extends AppCompatActivity {
    ...
    private final NavigationLocationProvider navigationLocationProvider =
            new NavigationLocationProvider();
    ...
    private final LocationObserver locationObserver = new LocationObserver() {
        ...
        public void onNewLocationMatcherResult(@NonNull LocationMatcherResult locationMatcherResult) {
            ...
            navigationLocationProvider.changePosition(location, locationMatcherResult.getKeyPoints(),
                    null, null);
            if(focusLocation)
            {
        ...
        public void onRoutesChanged(@NonNull RoutesUpdatedResult routesUpdatedResult) {
            routeLineApi.setNavigationRoutes(routesUpdatedResult.getNavigationRoutes(), new MapboxNavigationConsumer<Expected<RouteLineError, RouteSetValue>>() {
                ...
                public void accept(Expected<RouteLineError, RouteSetValue> routeLineErrorRouteSetValueExpected) {
                    try {
                        Method getStyleMethod = mapView.getClass().getDeclaredMethod("getStyle");
                        getStyleMethod.setAccessible(true);
                        Style style = (Style) getStyleMethod.invoke(mapView);
                        if(style != null)
                        {
                        ...
                        e.printStackTrace();
                        Log.e("YourClass", "Failed to get style: " + e.getMessage());
                    }
                }
            });
        }
    ...
    private final ActivityResultLauncher<String> activityResultLauncher = registerForActivityResult(
            new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
                ...
                public void onActivityResult(Boolean result) {
                    if(result)
                    {
                        Toast.makeText(MainActivity.this, "Permission granted! Restart this app"
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        speechApi = new MapboxSpeechApi(MainActivity.this, getString(R.string.mapbox_access_token)
        , Locale.US.toLanguageTag());
        mapboxVoiceInstructionsPlayer = new MapboxVoiceInstructionsPlayer(MainActivity.this
        , Locale.US.toLanguageTag());
        ...
        placeAutocompleteUiAdapter = new PlaceAutocompleteUiAdapter(searchResultsView,
                placeAutocomplete, LocationEngineProvider.getBestLocationEngine(MainActivity.this));
                ...
                if (isVoiceInstructionsMuted) {
                    ...
                    mapView.getMapboxMap().loadStyleUri(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
                        ...
                        public void onStyleLoaded(@NonNull Style style) {
                            ...
                            Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.pin_location);
                            ...
                            addOnMapClickListener(mapView.getMapboxMap(), new OnMapClickListener() {
                                ...
                                public boolean onMapClick(@NonNull Point point) {
                                    ...
                                    PointAnnotationOptions pointAnnotationOptions = new PointAnnotationOptions()
                                            .withTextAnchor(TextAnchor.CENTER).withIconImage(bitmap)
                                            .withPoint(point);
                ...
                private void fetchRoute(Point point)
                {
                    ...
                    locationEngine.getLastLocation(new LocationEngineCallback<LocationEngineResult>() {
                        ...
                        public void onSuccess(LocationEngineResult result) {
                            ...
                            Point origin = Point.fromLngLat(Objects.requireNonNull(location).getLongitude()
                            ...
                            mapboxNavigation.requestRoutes(builder.build(), new NavigationRouterCallback() {
                                ...
                                public void onFailure(@NonNull List<RouterFailure> list, @NonNull RouteOptions routeOptions) {
                                    setRoute.setEnabled(true);
                                    setRoute.setText("Bắt đầu");
                                    Toast.makeText(MainActivity.this, "Route request failed",
                                            Toast.LENGTH_SHORT).show();
